...
export default function AboutPage() {
  ...
  return (
    <>
      <SEO 
        title="За нас | Туристическа агенция за ученически екскурзии - Гоце Делчев, Гърмен"
        description="Friendly Travel е туристическа агенция за училища и ученически екскурзии в Гоце Делчев и Гърмен. Организираме образователни пътувания, зелени училища и групови екскурзии."
        keywords="туристическа агенция за ученически екскурзии, туристическа агенция за училища, туристическа агенция Гоце Делчев, туристическа агенция Гърмен, Friendly Travel, зелени училища, образователни екскурзии, групови пътувания"
        url="/about"
        image="/logo.png"
      />
      <Header />
      <Center>
        ...
        <ContentWrapper>
          ...
          <AnimatedSection ref={teamAnimation.ref} style={teamAnimation.style}>
            ...
            <Paragraph>
              Friendly Travel е създадена от двама опитни преподаватели, които обединяват своя професионален опит в образованието с страстта си към пътуванията. 
              Като <strong>туристическа агенция за училища</strong> в <strong>Гоце Делчев</strong> и <strong>Гърмен</strong>, нашата визия е да предоставим на младите хора и групи 
              възможност за обогатяващи изживявания, които допълват формалното обучение с практически знания и незабравими спомени.
            </Paragraph>
            <Paragraph>
              Благодарение на дългогодишния си опит в образователната система, нашият екип разпознава специфичните изисквания на училищата, учениците и техните семейства. 
              Това ни позволява да създаваме персонализирани програми за <strong>ученически екскурзии</strong> и <strong>зелени училища</strong>, които отговарят на образователните цели, 
              като едновременно осигуряват високо качество на услугите. Работим с проверени партньори за транспорт и настаняване, а нашите екскурзоводи са сертифицирани специалисти в своите области.
            </Paragraph>
          </AnimatedSection>
          ...
          <AnimatedSection ref={servicesAnimation.ref} style={servicesAnimation.style}>
            ...
            <ServicesList>
              ...
              <li>Кратки екскурзии в Гърция, Турция, Италия и България</li>
          ...
          <AnimatedSection ref={contactAnimation.ref} style={contactAnimation.style}>
            ...
            <Paragraph>
              За повече информация за нашите <strong>ученически екскурзии</strong> и <strong>зелени училища</strong>, 
              моля посетете нашата <Link href="/school-trips" style={{color: '#b8860b', textDecoration: 'underline'}}>специална страница за ученически екскурзии</Link>.
            </Paragraph>
